 ...
 */
export function getRecommendedCurrencies(userType: 'beginner' | 'experienced' = 'beginner'): CryptoVariant[] {
  if (userType === 'beginner') {
    ...
    return [...USDT_VARIANTS, ...FALLBACK_CURRENCIES]
      .sort((a, b) => a.averageConfirmationTime - b.averageConfirmationTime);
  }
}