...
export const SUPPORT_REQUEST_RECEIVED =
...
export function formatFAQMessage(): string {
  return (
    `${createHeader('Frequently Asked Questions', '💡')}\n` +
